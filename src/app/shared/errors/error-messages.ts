...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  CATALOG_NOT_FOUND:
    'El catálogo indicado no existe. Importá catálogos primero o revisá el nombre.',
  BRANCH_NOT_FOUND: 'Sucursal no encontrada',
  CATEGORY_NOT_FOUND:
    'La categoría indicada no existe. Importá categorías primero o revisá el slug.',
  ...
  BULK_FILE_INVALID:
    'No pudimos leer el archivo. Verificá que sea un Excel .xlsx válido y que no esté dañado.',
  ...
  BULK_HEADERS_INVALID:
    'El Excel no tiene las columnas obligatorias (comando y slug). Descargá la plantilla de nuevo.',
  BULK_PARSE_CHILDREN:
    'Revisá el formato de presentaciones, acabados, colores, secciones o imágenes en esa fila.',
  ROW_ERROR_GENERIC:
    'No se pudo procesar esta fila. Revisá los datos e intentá de nuevo.',
};
